...
class WhatsAppController extends Controller
{
            ...
            $response = $client->post("https://graph.facebook.com/v21.0/{$this->phoneNumberId}/messages", [
                ...
                'json' => [
                    ...
                    'interactive'       => [
                        'type' => 'button',
                        'body' => [
                            'text' => 'नमस्कार! *श्रीनाथ म्हस्कोबा मंदिर, वीर (कोडीत)* मध्ये आपले हार्दिक स्वागत आहे 🙏🏻 कृपया आपली भाषा निवडा.' . "\n\n" .
                                      'Hello! Welcome to *Shrinath Mhaskoba Mandir, Veer (Kodit)* 🙏🏻 Please choose your language.'
                        ],
                        'action' => [
                            'buttons' => [
    ...
    private function sendDonationOptions($phoneNumber, $language)
    {
        ...
        $messageText = $language === 'marathi'
            ? 'दान / सेवा पर्याय निवडा: एकदाच किंवा मासिक सेवा.'
